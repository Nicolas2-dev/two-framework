...
use Two\Exception\PlainDisplayer; // Not used
use Two\Exception\WhoopsDisplayer; // Not used
use Two\Exception\ExceptionDisplayerInterface; // Not used
...
class Handler
{
    ...
    {
        return $this->app->make('Two\Foundation\Exceptions\HandlerInterface');
    }
}
